...
function previewImage() {
  ...
  if (!filename) {
    ...
    $("previewText").innerText = "🖼️ Image preview";
  ...
  $("imagePreview").onerror = () => {
    ...
    $("imageStatus").innerText =
      "⚠️ Check filename, extension and products folder.";
...
async function saveProduct() {
  ...
  try {
    ...
    $("productMessage").innerText =
      "❌ Firebase error. Product could not be saved.";
...
$("saveSettingsBtn").addEventListener(
  ...
  async () => {
    ...
    if (
      ...
      $("settingsMessage").innerText =
        "⚠️ Coupon discount must be between 0-100%.";
...
window.contactCustomer =
  function(phone) {
    ...
    if (!phone) {
      ...
      alert(
        "⚠️ Customer phone number not available."
      );
